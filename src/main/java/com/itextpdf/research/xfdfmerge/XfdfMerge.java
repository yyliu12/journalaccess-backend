...
public class XfdfMerge {
    ...
    public void mergeXfdfIntoPdf(XfdfObject xfdfObject) {
     ...
     *
     * @param annotsObject The AnnotsObject with children AnnotObject entities to be
     *                     mapped into PdfAnnotations.
     */
    ...
    private void addCommonAnnotationAttributes(PdfAnnotation annotation, AnnotObject annotObject, Color color) {
        annotation.setFlags(
                XfdfObjectReadingUtils.convertFlagsFromString(annotObject.getAttributeValue(XfdfConstants.FLAGS)));
    ...
    private Rectangle readAnnotRectAndResize(AnnotObject annotObject) {
        ...
        if (annotName != null) {
            ...
            switch (annotName) {
                ...
                case XfdfConstants.FREETEXT:
                    PdfFreeTextAnnotation freeText = new PdfFreeTextAnnotation(readAnnotRect(annotObject),
